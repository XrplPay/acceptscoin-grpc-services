...
using AcceptsCoin.Services.EmailSenderServer.Data.Context;
using AcceptsCoin.Services.EmailSenderServer.Domain.Interfaces;
using AcceptsCoin.Services.EmailSenderServer.Domain.Models;
using Microsoft.EntityFrameworkCore;

namespace AcceptsCoin.Services.EmailSenderServer.Data.Repository
{

    public class MessageRepository : IMessageRepository
    {

        private AcceptsCoinEmailSenderDbContext _context;

        public MessageRepository(AcceptsCoinEmailSenderDbContext context)
        {
            _context = context;
        }
