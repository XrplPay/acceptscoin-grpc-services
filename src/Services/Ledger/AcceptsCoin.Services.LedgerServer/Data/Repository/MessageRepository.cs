...
using AcceptsCoin.Services.LedgerServer.Data.Context;
using AcceptsCoin.Services.LedgerServer.Domain.Interfaces;
using AcceptsCoin.Services.LedgerServer.Domain.Models;
using Microsoft.EntityFrameworkCore;

namespace AcceptsCoin.Services.LedgerServer.Data.Repository
{

    public class MessageRepository : IMessageRepository
    {

        private AcceptsCoinLedgerSenderDbContext _context;

        public MessageRepository(AcceptsCoinLedgerSenderDbContext context)
        {
            _context = context;
        }
