...
namespace AcceptsCoin.Services.IdentityServer.Migrations
{
    ...
    [Migration("20220116234230_Partner")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AcceptsCoin.Services.IdentityServer.Domain.Models.Partner", b =>
                {
            ...
            modelBuilder.Entity("AcceptsCoin.Services.IdentityServer.Domain.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2022, 1, 17, 2, 42, 29, 581, DateTimeKind.Local).AddTicks(6630),
                            Deleted = false,
                            Name = "Administrator",
                            Published = true
                        },
                        new
                        {
                            ...
                            CreatedById = new Guid("999bb90f-3167-4f81-83bb-0c76d1d3ace5"),
                            CreatedDate = new DateTime(2022, 1, 17, 2, 42, 29, 581, DateTimeKind.Local).AddTicks(9270),
                            Deleted = false,
                            Name = "Business",
                            Published = true
                        },
                        new
                        {
                            ...
                            CreatedById = new Guid("999bb90f-3167-4f81-83bb-0c76d1d3ace5"),
                            CreatedDate = new DateTime(2022, 1, 17, 2, 42, 29, 581, DateTimeKind.Local).AddTicks(9290),
                            Deleted = false,
                            Name = "Partner",
                            Published = true
                        },
                        new
                        {
                            ...
                            CreatedById = new Guid("999bb90f-3167-4f81-83bb-0c76d1d3ace5"),
                            CreatedDate = new DateTime(2022, 1, 17, 2, 42, 29, 581, DateTimeKind.Local).AddTicks(9300),
                            Deleted = false,
                            Name = "User",
                            Published = true
                        });
            ...
            modelBuilder.Entity("AcceptsCoin.Services.IdentityServer.Domain.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Activated = true,
                            CreatedById = new Guid("999bb90f-3167-4f81-83bb-0c76d1d3ace5"),
                            CreatedDate = new DateTime(2022, 1, 17, 2, 42, 29, 547, DateTimeKind.Local).AddTicks(5660),
                            Deleted = false,
            ...
            modelBuilder.Entity("AcceptsCoin.Services.IdentityServer.Domain.Models.User", b =>
                {
                    ...
                    b.HasOne("AcceptsCoin.Services.IdentityServer.Domain.Models.Partner", "Partner")
                        .WithMany()
