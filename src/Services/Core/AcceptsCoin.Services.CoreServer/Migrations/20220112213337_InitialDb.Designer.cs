...
namespace AcceptsCoin.Services.CoreServer.Migrations
{
    ...
    [Migration("20220112213337_InitialDb")]
            ...
            modelBuilder.Entity("AcceptsCoin.Services.CoreServer.Domain.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2022, 1, 13, 0, 33, 36, 156, DateTimeKind.Local).AddTicks(4690),
                            Deleted = false,
                            Icon = "",
                            Logo = "",
                            Name = "Food",
                        ...
                        new
                        {
                            ...
                            CreatedById = new Guid("999bb90f-3167-4f81-83bb-0c76d1d3ace5"),
                            CreatedDate = new DateTime(2022, 1, 13, 0, 33, 36, 167, DateTimeKind.Local).AddTicks(9800),
                            Deleted = false,
                            Icon = "",
                            Logo = "",
                            Name = "Car",
            ...
            modelBuilder.Entity("AcceptsCoin.Services.CoreServer.Domain.Models.Language", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "en",
                            CreatedById = new Guid("999bb90f-3167-4f81-83bb-0c76d1d3ace5"),
                            CreatedDate = new DateTime(2022, 1, 13, 0, 33, 36, 168, DateTimeKind.Local).AddTicks(8000),
                            Deleted = false,
                            Icon = "",
                            Logo = "",
                            Name = "ENGLISH",
            ...
            modelBuilder.Entity("AcceptsCoin.Services.CoreServer.Domain.Models.Partner", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ContactNumber = "0000",
                            CreatedById = new Guid("999bb90f-3167-4f81-83bb-0c76d1d3ace5"),
                            CreatedDate = new DateTime(2022, 1, 13, 0, 33, 36, 169, DateTimeKind.Local).AddTicks(3600),
                            Deleted = false,
